...
<Drawer.Root direction="left">
					...
					<div class="flex h-16 items-center justify-between">
							...
							<div class="flex h-full space-x-8">
								<div class="group/popover flex">
									<div class="relative flex">
										<button
											popovertarget="desktop-menu-women"
											class="relative flex items-center justify-center text-sm font-medium transition-colors duration-200 ease-out group-not-has-open/popover:text-gray-700 group-has-open/popover:text-indigo-600 group-not-has-open/popover:hover:text-gray-800"
										>
											Women
											<span
												aria-hidden="true"
												class="absolute inset-x-0 -bottom-px z-30 h-0.5 bg-transparent duration-200 ease-in group-has-open/popover:bg-indigo-600 group-has-open/popover-group:duration-150 group-has-open/popover-group:ease-out"
											></span>
										</button>
									</div>
									<el-popover
										id="desktop-menu-women"
										anchor="bottom"
										popover
										class="w-full overflow-visible bg-white text-sm text-gray-500 transition transition-discrete [--anchor-gap:1px] backdrop:bg-transparent open:block data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in"
									>
										<div
											aria-hidden="true"
											...
											<div class="mx-auto max-w-7xl px-8">
												<div class="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
													<div class="grid grid-cols-2 grid-rows-1 gap-8 text-sm">
														<div
															class="group relative col-span-2 overflow-hidden rounded-md bg-gray-100"
														>
															<img
																src="https://tailwindcss.com/plus-assets/img/ecommerce-images/mega-menu-category-01.jpg"
																alt="Models sitting back to back, wearing Basic Tee in black and bone."
																class="aspect-2/1 w-full object-cover group-hover:opacity-75"
															/>
													...
													<div class="grid grid-cols-3 gap-x-8 gap-y-10 text-sm text-gray-500">
														...
														<div class="space-y-10">
															...
															<div>
																...
																<ul
																	role="list"
																	aria-labelledby="women-accessories-heading"
																	class="mt-4 space-y-4"
																>
																	<li class="flex">
								...
								<div class="group/popover flex">
									<div class="relative flex">
										<button
											popovertarget="desktop-menu-men"
											class="relative flex items-center justify-center text-sm font-medium transition-colors duration-200 ease-out group-not-has-open/popover:text-gray-700 group-has-open/popover:text-indigo-600 group-not-has-open/popover:hover:text-gray-800"
										>
											Men
											<span
													...
													<div class="grid grid-cols-3 gap-x-8 gap-y-10 text-sm text-gray-500">
														<div class="space-y-10">
															<div>
																...
																<ul
																	role="list"
																	aria-labelledby="men-shoes-heading"
																	class="mt-4 space-y-4"
																>
																	<li class="flex">
																		<a href="#" class="hover:text-gray-800">Sneakers</a>
														...
														<div class="space-y-10">
															<div>
																...
																<ul
																	role="list"
																	aria-labelledby="men-clothing-heading"
																	class="mt-4 space-y-4"
																>
																	<li class="flex">
																		<a href="#" class="hover:text-gray-800">Basic Tees</a>
															...
															<div>
																...
																<ul
																	role="list"
																	aria-labelledby="men-accessories-heading"
																	class="mt-4 space-y-4"
																>
																	<li class="flex">
																		<a href="#" class="hover:text-gray-800">Watches</a>
														...
														<div class="space-y-10">
															<div>
																...
																<ul
																	role="list"
																	aria-labelledby="men-brands-heading"
																	class="mt-4 space-y-4"
																>
																	<li class="flex">
																		<a href="#" class="hover:text-gray-800">Re-Arranged</a>
						...
						<div class="flex flex-1 items-center justify-end">
							...
							<div class="ml-4 flow-root lg:ml-6">
								<button type="button" onclick={openCart} class="group -m-2 flex items-center p-2">
									<svg
										viewBox="0 0 24 24"
										fill="none"
										stroke="currentColor"
	...
	<Drawer.Content
		...
		class="flex max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl"
	>
			...
			<div class="border-b border-gray-200">
				<div class="-mb-px flex space-x-8 px-4" role="tablist">
					<button
						...
						onclick={() => (activeTab = 'women')}
						class="flex-1 border-b-2 border-transparent px-1 py-4 text-base font-medium whitespace-nowrap text-gray-900 aria-selected:border-indigo-600 aria-selected:text-indigo-600"
					>
						Women
					</button>
					<button
					...
					<div class="space-y-10">
						...
						<div>
							...
							>
								...
								<li class="flow-root"><a href="#" class="-m-2 block p-2 text-gray-500">Core</a></li>
								<li class="flow-root">
									<a href="#" class="-m-2 block p-2 text-gray-500">New Arrivals</a>
								</li>
								<li class="flow-root"><a href="#" class="-m-2 block p-2 text-gray-500">Sale</a></li>
								<li class="flow-root">
					...
					<div class="space-y-10">
						<div>
							...
							>
								...
								<li class="flow-root"><a href="#" class="-m-2 block p-2 text-gray-500">Tops</a></li>
								<li class="flow-root">
						...
						<div>
							...
							>
								...
								<li class="flow-root"><a href="#" class="-m-2 block p-2 text-gray-500">Bags</a></li>
								<li class="flow-root">
									<a href="#" class="-m-2 block p-2 text-gray-500">Sunglasses</a>
								</li>
								<li class="flow-root"><a href="#" class="-m-2 block p-2 text-gray-500">Hats</a></li>
								<li class="flow-root">
